        ...
        <Container>
                    ...
                    <Box display={{md:'flex'}}>
                        <Box flexGrow={1}>
                            ...
                            <p>Full Stack Developer / Data Quality Specialist</p>
                        </Box>
                        <Box 
                        flexShrink={0} 
                        mt={{base: 4, md: 0}} 
                    ...
                    <Section delay={0.1}>
                        ...
                        <Paragraph>Hi!  My name is Lucas, and I&apos;m a data quality specialist and full stack developer. I started this 
                        site as a portfolio for my coding projects. I&apos;m always trying to expand my portfolio
                    ...
                    <Section delay={0.2}>
                        ...
                        <BioSection>
                            ...
                            I took a job at Cohere as a Data Quality Specialist.
                        </BioSection>
                    </Section>
                    ...
                    <Section delay={0.4}>
                        ...
                        <List>
                            ...
                            <ListItem>
                                <CopyButton text="lucascrawhallstein@outlook.com"/>
                            </ListItem>
                        </List>
                    </Section>
                </Container>
